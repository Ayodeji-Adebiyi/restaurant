        ...
        <div className={styles.container}>
            <div className={styles.wrapper}>
                ...
                <div className={styles.item}>
                    ...
                    <input type="text" placeholder="+234 811 7472 695" className={styles.input}/>
                </div>
                <div className={styles.item}>
                    <label className={styles.label} htmlFor="">Address</label>
                    <textarea rows="5" placeholder="Oda road, Akure" type="text" className={styles.textarea} onChange={(e)=>setCustomer(e.target.value)}></textarea>
                </div>
